...
const Footer = () => {
  return (
    <div style={{backgroundColor: '#FEE59A'}}>
         <Container>
            <Row>
                <Col lg={2} md={6} sm={12}>
                    ...
                    <div className='d-flex'>
                        <p to="#link"><span style={{color: 'white' , backgroundColor: '#FDCB35' , borderRadius: '50%' , padding: '10px' , objectFit: 'cover' , cursor: 'pointer'}}><BsFacebook /></span></p>
                        <p to="#link"><span style={{color: 'white' , backgroundColor: '#FDCB35' , borderRadius: '50%' , padding: '10px' , objectFit: 'cover' , marginLeft: '7px' , cursor: 'pointer'}}><BsInstagram /></span></p>
                        <p to="#link"><span style={{color: 'white' , backgroundColor: '#FDCB35' , borderRadius: '50%' , padding: '10px' , objectFit: 'cover' , marginLeft: '7px' , cursor: 'pointer'}}><BsLinkedin /></span></p>
                        <p to="#link"><span style={{color: 'white' , backgroundColor: '#FDCB35' , borderRadius: '50%' , padding: '10px' , objectFit: 'cover' , marginLeft: '7px' , cursor: 'pointer'}}><BsTwitter /></span></p>
                    </div>
                </Col>
